...
INSERT INTO `Patients` (`patientID`, `firstName`, `lastName`, `ssn`, `dob`, `streetAddress`, `city`, `state`, `zip`, `phone`) VALUES
(1, 'Jane', 'Doe', '111111111', '1996-01-05','901 E Van Buren St.', 'Phoenix', 'AZ', '85006', '111-222-1111'),
(2, 'John', 'Smith', '222222222', '1990-11-15', '1111 W Linden St.', 'Goodyear', 'AZ', '85338', '222-333-2222'),
(3, 'Pat', 'Michel', '333333333', '1964-03-17', '123 N Kesler St.', 'Goodyear', 'AZ', '85338', '333-444-3333'),
(4, 'Austin', 'Barkley', '444444444', '1980-12-05', '5555 S Park St.', 'Avondale', 'AZ', '86444', '444-555-4444'),
(5, 'Theresa', 'Lee', '555555555', '1975-06-12', '3333 Tumbleweed Rd.', 'Phoenix', 'AZ', '85006', '555-666-5555');
...
--
ALTER TABLE `PatientDetails`
  ADD CONSTRAINT `fk_nurseID` FOREIGN KEY (`nurseID`) REFERENCES `Nurses` (`nurseID`) ON DELETE SET NULL,
  ADD CONSTRAINT `fk_patientID` FOREIGN KEY (`patientID`) REFERENCES `Patients` (`patientID`) ON DELETE CASCADE,
  ADD CONSTRAINT `fk_physicianID` FOREIGN KEY (`physicianID`) REFERENCES `Physicians` (`physicianID`) ON DELETE CASCADE;
...
ALTER TABLE `Treatments`
  ...
  ADD CONSTRAINT `fk_patientID_1` FOREIGN KEY (`patientID`) REFERENCES `Patients` (`patientID`) ON DELETE CASCADE;
COMMIT;
